...
import 'package:mobilino_app/screens/return_page/store_page.dart';
...
import 'package:mobilino_app/widgets/drawers/return_drawer.dart';
import 'package:provider/provider.dart';

import 'delivred_history.dart';
import 'return_history_page.dart';

class ReturnListPage extends StatefulWidget {
  const ReturnListPage({super.key});

  static const String routeName = '/return';

  static Route route() {
    return MaterialPageRoute(
      settings: RouteSettings(name: routeName),
      builder: (_) => ReturnListPage(),
    );
  }
