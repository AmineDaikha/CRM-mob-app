...
class AddOpportunityPage extends StatefulWidget {
  ...
  const AddOpportunityPage({super.key, this.proposedStart});
...
class _AddOpportunityPageState extends State<AddOpportunityPage> {
              ...
              children: [
                ...
                ListTile(
                  ...
                  subtitle: DropdownButtonFormField<StepPip>(
                    ...
                    items: AppUrl.filtredOpporunity.pipeline!.steps
                  ...
                  child: InkWell(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          '${DateFormat('dd-MM-yyyy HH:mm:ss').format(selectedEndTimeDate)}',
                          style: Theme.of(context).textTheme.headline3,
                        ),
                      ],
                    ),
                    ...
                    onPressed: () async {
                      if (formKey.currentState != null &&
                        ...
                        try {
                          ...
                          _showAlertDialog(
                              context, 'Il faut choisir un client d\'abord !');
                          return;
                        }
                        ...
                        if (confirmed) {
                          ...
                          sendOpportunity(context, client!).then((value) {
                            if (value) {
                              HttpRequestApp().sendItinerary('OPT');
                              showMessage(
                                  message:
                                      'L\'opportunité a été créée avec succès',
                                  context: context,
                                  color: primaryColor);
                              ...
                              showMessage(
                                  message:
                                      'Échec de creation de l\'opportunité',
                                  context: context,
                                  color: Colors.red);
                              Navigator.pop(context);
                            }
  ...
  Future<bool> sendOpportunity(BuildContext context, Client client) async {
    ...
    print(
        'url: http://"+AppUrl.user.company!+".my-crm.net:5188/api/Opportunites');
