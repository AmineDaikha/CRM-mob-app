...
class CommandDelivredPage extends StatefulWidget {
  final Client client;

  const CommandDelivredPage({
    super.key,
  ...
  @override
  State<CommandDelivredPage> createState() => _CommandDelivredPageState();
}

class _CommandDelivredPageState extends State<CommandDelivredPage> {
  double total = 0;
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Payée : ${AppUrl.formatter.format(widget.client.command!.paid)} DZD',
                                  style: Theme.of(context)
                                      .textTheme
                                      .headline4!
                                      .copyWith(
