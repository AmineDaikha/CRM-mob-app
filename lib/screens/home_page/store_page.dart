...
class StorePage extends StatefulWidget {
  ...
  const StorePage({super.key, required this.client, required this.callback});
                        ...
                        onPressed: () {
                          setState(() {
                            ...
                            if (widget.product.quantity >=
                              ...
                              showMessage(
                                  message:
                                      'Quantité supérieure à la quantité en stock',
                                  context: context,
                                  color: Colors.red);
                            }
...
Future<int?> getQuantityMax(String artCode) async {
  String url = AppUrl.getQuantityMax + '${AppUrl.user.etblssmnt!.code}/${AppUrl.user.localDepot!.id}/$artCode';
  print(
      'url: ');
  http.Response req = await http.get(
      Uri.parse(
