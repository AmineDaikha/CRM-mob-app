...
class DuplicateActivityPage extends StatefulWidget {
  ...
  const DuplicateActivityPage({super.key,
...
class _DuplicateActivityPageState extends State<DuplicateActivityPage> {
  ...
  void initState() {
    ...
    super.initState();
    print(
        'oppoCodeIs : ${widget.activity.client.idOpp} ${widget.activity
            .emergency}');
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  RatingBar.builder(
                    initialRating: widget.activity.priority!,
                    minRating: 1.0,
                    maxRating: 5.0,
                    itemCount: 5,
                    // Number of stars
              ...
              Row(
                ...
                children: [
                  ...
                  RatingBar.builder(
                    initialRating: widget.activity.emergency!,
                    minRating: 1.0,
                    maxRating: 5.0,
                    itemCount: 5,
                    // Number of stars
              ...
              //         Image.file(File(AppUrl.imageUrl), fit: BoxFit.cover,
              //           width: 200,
              //           height: 150,)
              //     ],
              //   ),
