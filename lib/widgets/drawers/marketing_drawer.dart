...
class DrawerMarketingPage extends StatefulWidget {
  int selectedItemIndex;

  DrawerMarketingPage({Key? key, required this.selectedItemIndex})
      : super(key: key);

  @override
  State<DrawerMarketingPage> createState() => _DrawerMarketingPageState();
}

class _DrawerMarketingPageState extends State<DrawerMarketingPage> {
  bool isVisible = true;
  @override
                              ...
                              children: [
                                InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: widget.selectedItemIndex == 0
                                        ? BoxDecoration(
                                            border: Border(
                                                left: BorderSide(
                                            width: 2.5,
                                ...
                                InkWell(
                                  ...
                                  child: Container(
                                    padding: EdgeInsets.only(left: 5),
                                    decoration: widget.selectedItemIndex == 1
                                        ? BoxDecoration(
                                        border: Border(
                                            left: BorderSide(
                                              width: 2.5,
                                ...
                                InkWell(
                                  ...
                                  child: Container(
                                    padding: EdgeInsets.only(left: 5),
                                    decoration: widget.selectedItemIndex == 2
                                        ? BoxDecoration(
                                        border: Border(
                                            left: BorderSide(
                                              width: 2.5,
