...
class DrawerCatalogPage extends StatefulWidget {
  const DrawerCatalogPage({
    Key? key,
  }) : super(key: key);

  @override
  State<DrawerCatalogPage> createState() => _DrawerCatalogPageState();
}

class _DrawerCatalogPageState extends State<DrawerCatalogPage> {
