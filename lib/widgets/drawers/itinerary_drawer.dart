...
class DrawerItineraryPage extends StatefulWidget {
  const DrawerItineraryPage({
    Key? key,
  }) : super(key: key);

  @override
  State<DrawerItineraryPage> createState() => _DrawerItineraryPageState();
}

class _DrawerItineraryPageState extends State<DrawerItineraryPage> {
