...
class DrawerMyActivitiesPage extends StatefulWidget {
  const DrawerMyActivitiesPage({
    Key? key,
  }) : super(key: key);

  @override
  State<DrawerMyActivitiesPage> createState() => _DrawerMyActivitiesPageState();
}

class _DrawerMyActivitiesPageState extends State<DrawerMyActivitiesPage> {
