...
class DrawerNotesPage extends StatefulWidget {
  const DrawerNotesPage({
    Key? key,
  }) : super(key: key);

  @override
  State<DrawerNotesPage> createState() => _DrawerNotesPageState();
}

class _DrawerNotesPageState extends State<DrawerNotesPage> {
