...
class DrawerPaymentPage extends StatefulWidget {
  const DrawerPaymentPage({
    Key? key,
  }) : super(key: key);

  @override
  State<DrawerPaymentPage> createState() => _DrawerPaymentPageState();
}

class _DrawerPaymentPageState extends State<DrawerPaymentPage> {
